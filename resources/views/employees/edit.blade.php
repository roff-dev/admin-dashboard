<x-app-layout>
        <div class="container mx-auto py-6">
            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
                <h1 class="text-2xl font-bold text-gray-200 mb-4">Edit Employee</h1>
                ...
                <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- First Name Field --}}
                    <div class="mb-4">
                        <label for="first_name" class="block text-gray-200 font-medium">First Name <span class="text-red-500">*</span></label>
                    ...
                    {{-- Last Name Field --}}
                    <div class="mb-4">
                        <label for="last_name" class="block text-gray-200 font-medium">Last Name <span class="text-red-500">*</span></label>
                    ...
                    {{-- Phone Field --}}
                    <div class="mb-4">
                        <label for="phone" class="block text-gray-200 font-medium">Phone</label>
                    ...
                    {{-- Company Field --}}
                    <div class="mb-4">
                        <label for="company_id" class="block text-gray-200 font-medium">Company</label>
