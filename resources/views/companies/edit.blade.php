<x-app-layout>
        <div class="container mx-auto py-6">
            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
                <h1 class="text-2xl font-bold text-gray-200 mb-4">Edit Company</h1>
                ...
                <form action="{{ route('companies.update', $company->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- Name Field --}}
                    <div class="mb-4">
                        <label for="name" class="block text-gray-200 font-medium">Company Name <span class="text-red-500">*</span></label>
                    ...
                    {{-- Email Field --}}
                    <div class="mb-4">
                        <label for="email" class="block text-gray-200 font-medium">Company Email</label>
                    ...
                    {{-- Website Field --}}
                    <div class="mb-4">
                        <label for="website" class="block text-gray-200 font-medium">Company Website</label>
                    ...
                    {{-- Logo Field --}}
                    <div class="mb-4">
                        <label for="logo" class="block text-gray-200 font-medium">Logo</label>
                        @if($company->logo)
                            <div class="mb-2">
